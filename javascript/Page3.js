let apiCardApi = new TempApi.CardApi();import TempApi from '../src/index';document.getElementById('iszgg').onclick = (event) => {
    event.preventDefault();
    { location.href= '/Page1';}};document.getElementById('idztf').onclick = (event) => {
    event.preventDefault();
    { location.href= '/Page2';}};window.onload = () => {apiCardApi.getAllcard((error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); const subDataElements = document.getElementById("iy7c").querySelectorAll( "[dataitem='true']" );
  data.forEach((item,i) => {
  ...
  apiCardApi.getAllcard((error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); const subDataElements = document.getElementById("iy7c").querySelectorAll( "[dataitem='true']" );
