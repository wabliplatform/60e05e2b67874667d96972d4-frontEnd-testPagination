...
(function(root, factory) {
  ...
  describe('Card', function() {
    it('should create an instance of Card', function() {
      ...
      //var instane = new TempApi.Card();
      //expect(instance).to.be.a(TempApi.Card);
    });
    ...
    it('should have the property cardDescription (base name: "cardDescription")', function() {
